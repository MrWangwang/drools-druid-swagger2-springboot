...
public class RulesController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "rule", dataType = "String",paramType = "query", required = false, value = "规则"),
            @ApiImplicitParam(name = "name", dataType = "String", paramType = "query",required = false, value = "规则名称")})
    @RequestMapping(value = "/add", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
    public JsonResponse ruleAdd(@RequestParam(value="rule") String rule, @RequestParam(value="name") String name) {
    ...
    public JsonResponse POSTRuleList() {
